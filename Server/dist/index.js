...
app.post("/api/sessions/:id/games", writeLimiter, (req, res, next) => {
    try {
      ...
      `)
        ...
        const calculatedScores = calculateLossScores(parsed.playerIds, parsed.winners, parsed.partyPoints, parsed.gewonnenVon, parsed.hochzeitPlayerId, parsed.soloPlayerId);
